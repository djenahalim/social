...
<div class='container fixed-bottom' id="people_search_form">
  <div class='row '>
...
<select name="age" class="form-select " aria-label="Default select example">
                ...
                <option value="3">40 and Over</option>
 </select>
</div>
<div class='col-1 pe-0' id='male_female' >
...
<div class="form-check">
 ...
 <select  name="country" class="form-select " aria-label="Default select example">
   <option default value="Any Country">Any Country</option>
